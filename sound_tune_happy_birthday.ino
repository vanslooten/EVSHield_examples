 ...
 * 
 * Example from:
 * https://github.com/AbhishekGhosh/Arduino-Buzzer-Tone-Codes/blob/master/Happy-Birthday-to-You.ino
 * 
...
// definition of first 4 parts of "Happy Birthday":
